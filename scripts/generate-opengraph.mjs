...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g transform="translate(378 168)">
    <rect width="144" height="144" rx="34" fill="#f43f5e"/>
  ...
  <text x="600" y="442" text-anchor="middle" font-family="Lato, sans-serif" font-size="38" font-weight="700" fill="#e11d48">neu gedacht.</text>
</svg>\n`;
