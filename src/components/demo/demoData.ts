...
export const demoModules: Module[] = [
  ...
  { name: 'Dateiverteilung', url: 'https://schulportal.hessen.de/dateiverteilung.php', direct_url: 'https://schulportal.hessen.de/dateiverteilung.php', proxy_app: false, color: '#15803d', logo: 'fa fa-files-o', folders: ['Schule'], target: '_self' },
